                    ...
                    <li wire:key="activity-{{ $activity['id'] }}">
                        <div class="relative pb-8">
                            ...
                            <div class="relative flex space-x-3">
                                <div>
                                    {{--
                                      Note: Dynamic Tailwind classes like bg-{{ color }}-500 might need safelisting
                                      in tailwind.config.js if they aren't used elsewhere.
                                    --}}
                                    <span class="h-8 w-8 rounded-full bg-{{ $activity['color'] ?? 'gray' }}-500 flex items-center justify-center ring-8 ring-white">
                                        <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            @elseif(($activity['icon'] ?? '') === 'folder-add')
                                ...
                                <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                                    <div>
                                        ...
                                        <p class="mt-0.5 text-xs text-gray-500">{{ __('by') }} {{ $activity['user'] }}</p>
                                    </div>
